...
def AIprompt(forecaststring,mood,music,inputlocation,language):
    ...
    if language == 'SE':
        ...
        askprompt = f'The weather today is as following: {forecaststring}. This is my mood: {mood}. I want tro listen to {music}. Please give me advice what is the best activities for me in {inputlocation} and how I can optimize my day based on this. Give me recommendations on how to dress according to the weather. Give me three affirmations based on all data that helps me get through the day.'
