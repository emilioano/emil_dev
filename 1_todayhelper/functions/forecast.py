...
def fetchforecast(currentlocation,lat,lon):
    ...
    if forecastresponse.status_code==200:
        ...
        #print('----------------------------------------------------------------------------------\n')
        forecaststring = f'Maximal temperatur i {currentlocation} idag blir {max_temp}, lägsta temperatur blir {min_temp}. Högsta vindhastighet blir {wind_speed_max} m/s. Det väntas regna {rain_sum} mm. Det väntas snöa {snowfall_sum} cm.'
