...
import json
import asyncio
from .dbactions import insertdbrecord
...
async def fetchsong(airesult,music,inputlocation,mood,ip):
    ...
    async def fetch_song(waittime):
        ...
        while True:
            ...
            if taskstatusdataresponse=='PENDING':
                ...
                insertdbrecord(ip,inputlocation,mood,music,airesult,audioUrl)
                return audioUrl
            else:
